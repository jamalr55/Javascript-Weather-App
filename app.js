...
tempElement2.addEventListener('click', function() {
	if (weather.temperature.value2 === undefined) return;

	if (weather.temperature.unit == 'celsius') {
		let fahrenheit = celsiusToFahrenheit(weather.temperature.value2);
		fahrenheit = Math.floor(fahrenheit);

		tempElement2.innerHTML = `${fahrenheit}°<span>F</span>`;
		weather.temperature.unit = 'fahrenheit';
	} else {
		tempElement2.innerHTML = `${weather.temperature.value2}°<span>C</span>`;
		weather.temperature.unit = 'celsius';
...
tempElement3.addEventListener('click', function() {
	if (weather.temperature.value3 === undefined) return;

	if (weather.temperature.unit == 'celsius') {
		let fahrenheit = celsiusToFahrenheit(weather.temperature.value3);
		fahrenheit = Math.floor(fahrenheit);

		tempElement3.innerHTML = `${fahrenheit}°<span>F</span>`;
		weather.temperature.unit = 'fahrenheit';
	} else {
		tempElement3.innerHTML = `${weather.temperature.value3}°<span>C</span>`;
		weather.temperature.unit = 'celsius';
...
tempElement4.addEventListener('click', function() {
	if (weather.temperature.value4 === undefined) return;

	if (weather.temperature.unit == 'celsius') {
		let fahrenheit = celsiusToFahrenheit(weather.temperature.value4);
		fahrenheit = Math.floor(fahrenheit);

		tempElement4.innerHTML = `${fahrenheit}°<span>F</span>`;
		weather.temperature.unit = 'fahrenheit';
	} else {
		tempElement4.innerHTML = `${weather.temperature.value4}°<span>C</span>`;
		weather.temperature.unit = 'celsius';
...
tempElement5.addEventListener('click', function() {
	if (weather.temperature.value5 === undefined) return;

	if (weather.temperature.unit == 'celsius') {
		let fahrenheit = celsiusToFahrenheit(weather.temperature.value5);
		fahrenheit = Math.floor(fahrenheit);

		tempElement5.innerHTML = `${fahrenheit}°<span>F</span>`;
		weather.temperature.unit = 'fahrenheit';
	} else {
		tempElement5.innerHTML = `${weather.temperature.value5}°<span>C</span>`;
		weather.temperature.unit = 'celsius';
